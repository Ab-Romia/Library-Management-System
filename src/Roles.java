...
public class Roles {
    ...
    public static void main(String[] args) {
        ...
        if (productDatabase.contains(searchKey)) {
            Product product = productDatabase.getRecord(searchKey);
        ...
        // Add a new product
        employeeRole.addProduct("P001", "Product 1", "Manufacturer 1", "Supplier 1", 10);
        ...
        boolean purchaseSuccessful = employeeRole.purchaseProduct(customerSSN, productID, purchaseDate);
